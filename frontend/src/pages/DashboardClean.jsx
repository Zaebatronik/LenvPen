...
// Система ленивца с 6 стадиями (Блок 6)
const SLOTH_STAGES = [
  { level: 0, range: [0, 10], emoji: '💀', text: 'Мне плохо. Всем плохо. Я не просил сюда приходить.' },
  { level: 1, range: [10, 30], emoji: '😴', text: 'Ладно, допустим, я сел. Но я недоволен.' },
  { level: 2, range: [30, 50], emoji: '🙂', text: 'Ну ладно… попробуем.' },
  { level: 3, range: [50, 70], emoji: '😌', text: 'Появляется энергия!' },
  { level: 4, range: [70, 90], emoji: '😎', text: 'Уверенный, мотивирую тебя!' },
  { level: 5, range: [90, 100], emoji: '🔥', text: 'Ты в 99% случаев достигнешь своей цели, так держать!' }
];
