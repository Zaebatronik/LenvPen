...
// Система ленивца T3 с 9 стадиями
const SLOTH_STAGES = [
  { level: 0, range: [0, 0], emoji: '😶', text: 'Вы только начали путь. Ваш ленивец ждёт вашего первого шага!', isStart: true },
  { level: 1, range: [1, 10], emoji: '😵', text: 'Он пытается встать… но передумал.' },
  { level: 2, range: [10, 20], emoji: '😴', text: 'Кажется, ленивец нашёл внутренний вайб.' },
  { level: 3, range: [20, 30], emoji: '😐', text: 'Он даже перестал зевать. Это серьёзно.' },
  { level: 4, range: [30, 50], emoji: '🙂', text: 'Он уже выглядит как ленивец, который знает, чего хочет.' },
  { level: 5, range: [50, 70], emoji: '😊', text: 'Он готов тягать штангу… но только одну.' },
  { level: 6, range: [70, 90], emoji: '😎', text: 'Он чувствует запах победы.' },
  { level: 7, range: [90, 100], emoji: '🔥', text: 'Ты почти достиг своей цели. Остался последний рывок!' },
  { level: 8, range: [100, 100], emoji: '🏆', text: 'Поздравляем! Вы достигли своей цели!', isVictory: true }
];
